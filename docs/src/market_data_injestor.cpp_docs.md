# File Documentation: market_data_injestor.cpp

## Metadata

- **File Path**: `src/market_data_injestor.cpp`
- **File Name**: `market_data_injestor.cpp`
- **Language**: C++
- **Lines of Code**: 144
- **Characters**: 4587
- **Words**: 428
...
**Header File**: [`market_data_injestor.h`](../market_data_injestor.h)
